# encoding: utf-8
'''
Description: This is a test case to check crash in no notification view controller.
...
class Test_Suite_02_No_Notification_View_Controller(object):
    ...
    def class_setup(self, mac_smart_setup):
        ...
        self.printer_1 = {"printerBonjourName": "HP ENVY Photo 7800 series [BADBAD]", "printerIP": "192.168.10.105", "printerType": "New_II_Eligible_Printer"}
        self.printer_2 = {"printerBonjourName": "HP PageWide Pro MFP 772-777z [98301E]", "printerIP": "192.168.10.161", "printerType": "New_II_Eligible_Printer"}
        self.printer_3 = {"printerBonjourName": "HP ENVY 5000 series [D950AB]", "printerIP": "192.168.10.143", "printerType": "New_II_Eligible_Printer"}
    ...
    def test_02_check_crash(self):
        '''
        This is a method to check crash in no notification view controller.
        '''
        for run_time in range(self.run_times):
            logging.debug("Start to check crash in no notification view controller...  :" + str(run_time))
            ...
            try:
                ...
                sleep(5)
                logging.debug("Relaunch app and click all printers in the carousel for testing... ")
                self.common_flows.launch_HPSmart_app(self.appname)
