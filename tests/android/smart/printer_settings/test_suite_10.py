...
class Test_Suite_Android_HPSmart(object):
    ...
    def test_retry_fax(self):
        ...
        self.fc.fd[FLOW_NAMES.SOFTFAX_FAX_HISTORY].select_history_record("sent_history_record_cell" , phone_number2 , "failed_icon")
        self.fc.fd[FLOW_NAMES.SEND_FAX_DETAILS].verify_send_fax_status(is_successful=False , check_sending=False)
        self.fc.fd[FLOW_NAMES.SEND_FAX_DETAILS].verify_phone_number(phone_number=phone_number1)
    ...
    def test_enable_notifications(self , opt_name):
        ...
        self.fc.fd[FLOW_NAMES.APP_SETTINGS].sign_out_hpc_acc()
