...
# encoding: utf-8
'''
Description: This is a test case to test function -- print from scan with local printer.
...
class Test_Suite_06_Print_From_Scan_Local(object):
    ...
    def test_02_print_from_scan_default_settings(self):
        '''
        TestRail:#
        This is a method to test send print job on the scan result screen with local printer.
        '''
        ...
        logging.debug("Print files from scan... ")
        self.common_flows.print_file_from_scan()
