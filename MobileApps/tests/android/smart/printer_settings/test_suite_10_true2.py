...
class Test_Suite_Android_HPSmart(object):
    ...
    #def class_setup(cls, request, android_smart_setup):
        ...
        cls.receiver_fake_number = "(212) 555-1235"
    ...
    def test_first_flow(self):
        ...
        self.fc.fd[FLOW_NAMES.COMPOSE_FAX].enter_recipient_information(self.recipient_info["phone"], self.receiver_name)
    ...
    def test_files(self , file_type ):
        ...
        try: 
            ...
            pass
        try:
            #self.fc.fd[FLOW_NAMES.SOFTFAX_FAX_HISTORY].verify_fax_history_screen(timeout=30)
            time.sleep(15)
    ...
    def test_retry_fax(self):
        ...
        phone_number='{} {}'.format('+1',self.recipient_info["phone"])
        ...
        try:
            ...
            self.fc.fd[FLOW_NAMES.SOFTFAX_FAX_HISTORY].select_history_record("sent_history_record_cell" , self.receiver_fake_number , "failed_icon")
        #self.fc.fd[FLOW_NAMES.SOFTFAX_FAX_HISTORY].select_history_record("sent_history_record_cell" , self.recipient_info["phone"] , status="successful_icon")
