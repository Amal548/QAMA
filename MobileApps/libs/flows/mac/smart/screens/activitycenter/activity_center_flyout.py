...
# -------------------------------Operate Elements-----------------------------------------
    ...
    def click_activity_center_smart_tasks(self):
        ...
        :return:
        '''
        logging.debug("[ActivityCenterFlyout]]:[click_activity_center_smart_tasks]-Click Smart Tasks option... ")
    ...
    def get_value_of_activity_center_print(self):
        ...
        :return:
        '''
        logging.debug("[ActivityCenterFlyout]:[get_value_of_dialog_title]-Get the value of Print option ...  ")
    ...
    def get_value_of_activity_center_smart_tasks(self):
        ...
        :return:
        '''
        logging.debug("[ActivityCenterFlyout]:[get_value_of_activity_center_smart_tasks]-Get the value of Smart Tasks option ...  ")
