...
########################################################################################################################
    ...
    def auth_logged_in_result(self):
        ...
        :return:
        """
        result = self.driver.get_attribute("auth_is_logged_in_result_txt", "Name")
    ...
    def auth_get_token_result(self):
        ...
        :return:
        """
        result = self.driver.get_attribute("auth_get_token_result_txt", "Name")
        return json.loads(result)
    ...
    def control_auth_token_switches(self,knobs):
        """
        controls switches under auth plugin
        :return:
        """
    ...
    def select_auth_logout_test(self):
        ...
        :return:
        """
        # account logout takes long time, confirmed with dev
    ...
    def auth_logout_result(self):
        ...
        :return:
        """
        result = self.driver.get_attribute("auth_logout_result_txt", "Name")
        return json.loads(result)
...
########################################################################################################################
    ...
    def verify_logged_in_button(self):
        ...
        :return:
        """
        return self.driver.wait_for_object("auth_logged_in_test_btn", timeout=15, raise_e=False)
    ...
    def verify_get_token_button(self):
        ...
        :return:
        """
        return self.driver.wait_for_object("auth_get_token_test_btn", timeout=15, raise_e=False)
    ...
    def verify_logout_button(self):
        ...
        :return:
        """
        return self.driver.wait_for_object("auth_logout_test_btn", timeout=15, raise_e=False)