...
class DataCollection(JwebDataCollectionFlow):
    ...
    def send_ui_event_result(self):
        ...
        """
        return json.loads(self.driver.get_attribute("data_collection_send_ui_event_response", "text"))

    def send_sys_info_event_result(self):
        """
        :return the send sys info event result
        """
        return json.loads(self.driver.get_attribute("data_collection_send_sys_info_event_response", "text"))
